...
Les interactions entre les différents serveurs et le serveur de score sur docker ne fonctionne pas.La piste du reverse proxy pour rediriger les requêtes est à l'étude.Néanmoins le projet fonctionne sans docker.